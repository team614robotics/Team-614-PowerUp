...
/**
 * Makes the the robot drive forward until the robot is not moving (nearly 0
 * velocity)
 */

// Might be necessary to include specific tolerances (because "a" rarely exactly
// equals 0)
// However isMoving seems to include thresholds of its own, not sure if they can
// be modified
