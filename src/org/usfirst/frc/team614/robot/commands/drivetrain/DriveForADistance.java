...
public class DriveForADistance extends Command {
	...
	protected void initialize() {
		...
		// Robot.drivetrain.getDistanceController().setSetpoint(SmartDashboard.getNumber("Drivetrain
		// Target Distance", 0));
	...
	protected void execute() {
		...
		// Robot.drivetrain.arcadeDrive(.7 * Robot.drivetrain.getPIDSpeed(), .7 *
		// Robot.drivetrain.getPIDRotateRate());
		// }
	}
