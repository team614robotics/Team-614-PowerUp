...
public class Math708 {
	...
	/**
	 * Performs linear interpolation between the points (x1,y1) and (x2,y2) and
	 * returns the interpolated value of the function at x_result.
	 * 
	 * @param x1
	 * @param y1
	 * @param x2
	...
	/**
	 * Used to round a floating point value to a given decimal place.
	 * 
	 * @param n
	 *            The floating point value.
	 * @param dig
	 *            The decimal place to round to (use negative numbers for places >
	 *            0.
	 * @return
	 */
	...
	/**
	 * Returns the length of a vector with the specified components.
	 * 
	 * @param x
	 * @param y
	 * @return
	...
	/**
	 * Returns true if x and y are both negative or both positive. Returns false if
	 * one value is negative and the other is positive.
	 * 
	 * @param x
	 * @param y
	 * @return
	...
	/**
	 * Checks to see if a value is between a high and lo parameter. If it is higher
	 * than the upper bound it returns the upper bound, if it is lower than the
	 * lower bound it returns the lower bound, otherwise it returns x.
	 * 
	 * @param x
	 * @param low
	 * @param high
	...
	/**
	 * Gets the percent error of a sensor reading with a desired value, but clips it
	 * to prevent the error being too low to overcome torque or so high that the
	 * error proposes mechanical issues
	 * 
	 * @param currentValue
	 * @param goalValue
	 * @param minimumValue
	 ...
	 * @return
	 */
	public static double getClippedPercentError(double currentValue, double goalValue, double minimumValue,
			double maximumValue) {
