...
/**
 * This class determines relative rotation of the robot by finding the
 * difference between the encoder values on either side.
 * 
 * @author 708
 */
public class EncoderRotationSensor extends RotationSensor {
	...
	/**
	 * Math used here has been verified to produce the current angle of the robot in
	 * degrees.
	 * 
	 * @return
	 */
