 ...
 *
 */
public class RightScaleOpposite extends CommandGroup {

	public RightScaleOpposite() {
		// Add Commands here:
		...
		addSequential(new DriveForADistance(220, speed));
		...
		addSequential(new DeliverScaleOppositeAuto());
	}
}
