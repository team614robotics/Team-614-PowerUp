...
/**
 * This class represents a rangefinding sensor that determines the distance of
...
public abstract class DistanceSensor {
	...
	/*
	 * Boundaries for triggering. The sensor is triggered (returns boolean true)
	 * when the distance is between the low trigger bound and the high trigger
	 * bound. If invertTriggerRange is true, the sensor is triggered when the
	 * distance is outside of the range.
	 */
	...
	/**
	 * Processes the voltage according to the sensor's specifications to yield a
	 * distance.
	 * 
	 * @return
	 */
	...
	/**
	 * Modify the trigger boundaries for the sensor. This call can be used before an
	 * call to isTriggered() to specify how the distance value is to be processed.
	 * 
	 * @param lowTriggerBound
	 *            - asks: is x >= low?
	 * @param highTriggerBound
	 *            - asks: is x also <= high?
	 * @param invertedTriggerRange
	 *            - switches direction of comparison operators
	 */
