...
/**
 * Represents a Logitech Gamepad connected to the driver station. Note: the
 * drivers for the gamepad should be installed on the driver station netbook.
 * 
...
public class Gamepad extends Joystick {
	...
	/**
	 * Get the value of a gamepad axis, adjusting for a dead zone.
	 * 
	 * @param axis
	 * @return
	 */
	...
	public void sendAxesToDashboard() {
		SmartDashboard.putNumber("Gamepad " + port + "Right Stick X:", Math708.round(getAxis(Gamepad.rightStick_X), 2));
		SmartDashboard.putNumber("Gamepad " + port + "Right Stick Y:", Math708.round(getAxis(Gamepad.rightStick_Y), 2));
		SmartDashboard.putNumber("Gamepad " + port + "Left Stick X:", Math708.round(getAxis(Gamepad.leftStick_X), 2));
		SmartDashboard.putNumber("Gamepad " + port + "Left Stick Y:", Math708.round(getAxis(Gamepad.leftStick_Y), 2));
	}
}
