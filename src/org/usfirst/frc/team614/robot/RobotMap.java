...
public class RobotMap {
	...
	public static final double DRIVETRAIN_ENCODER_PULSES_PER_REV = 356;
	public static final double DRIVETRAIN_DISTANCE_PER_PULSE = (DRIVETRAIN_WHEEL_DIAMETER * Math.PI)
			/ RobotMap.DRIVETRAIN_ENCODER_PULSES_PER_REV;
