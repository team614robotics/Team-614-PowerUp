 ...
 *
 */
public class DriveUntilHitCube extends Command {
	double speed;

    public DriveUntilHitCube(double speed) {
    ...
    protected boolean isFinished() {
    	if(Robot.intake.intakeLimitSwitchA.get() && Robot.intake.intakeLimitSwitchB.get() && Robot.intake.intakeLimitSwitchC.get()) {
            return true;
    	}
    	else
            return false;
